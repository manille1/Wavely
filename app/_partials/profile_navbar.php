...
<section id="side-menu">
    ...
    <?php if($_SERVER['REQUEST_URI'] !== '/profile') : ?>
        <a id="back_profile_btn" href="/profile">Retour au profile</a>
    <?php endif; ?>
    <a id="create_album_btn" href="/create-album"><img src="../assets/img/create_album.svg" alt="créer un album"></a>
</section>